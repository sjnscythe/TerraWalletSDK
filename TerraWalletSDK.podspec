...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = 'poc for terra money'

  s.homepage         = 'https://github.com/sjnscythe/TerraWalletSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'sjnscythe' => 'scytheabhi97@gmail.com' }
  s.source           = { :git => 'https://github.com/sjnscythe/TerraWalletSDK.git', :tag => s.version.to_s }
